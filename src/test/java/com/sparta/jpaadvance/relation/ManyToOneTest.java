...
public class ManyToOneTest {
    ...
    void test2() {
        ...
        // 외래 키의 주인이 아닌 User에서 food를 저장해보기
        User user = new User();
        user.setName("Robbie");
    ...
    void test3() {
        ...
        // 외래 키의 주인이 아닌 User에서 Food 를 쉽게 저장하기 위해 addFoodList() 메서드 생성
        // 해당 메서드에 의해 외래 키(연관관계)설정 food.setUser(this); 추가
        User user = new User();
        user.setName("Robbie");
